...
import {getAssignedTasks} from "../../api/task.api.js";
...
export const getUserFieldMenu = (user) => {
    const html =
        `<ul class="w-48 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            <li class="w-full px-4 py-2 border-b border-gray-200 rounded-t-lg dark:border-gray-600 showAssigned cursor-pointer hover:bg-gray-800 hover:dark:bg-gray-800">Ver tareas asignadas</li>
            <li class="w-full px-4 py-2 border-b border-gray-200 rounded-t-lg dark:border-gray-600 cursor-pointer hover:bg-gray-800 hover:dark:bg-gray-800">Ver tareas realizadas</li>
        </ul>`;
